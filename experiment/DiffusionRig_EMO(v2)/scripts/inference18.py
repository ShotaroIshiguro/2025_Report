...
from utils.script_util18 import (
...
LINE_BOT_ACCESS_TOKEN = 'WGsmVwgTIISWkS+KuRA+7Gj65pLHBGUaongoy+LMH25svnrCFYrSoPmM7M0PslkccYdQ+RkGQnsOvgY2dWZdnj8uvG70RHkShTDADbh0JzjPrLwUXEfZJulOdbqqE3LURQCPjtZur1ULvK2+4UZdTgdB04t89/1O/w1cDnyilFU='
LINE_USER_ID = 'Ub0c39dd6eb5c79b3af0c7fa5ced32841'
...
def main():
    ...
    # )
    if args.sampler == "ddpm":             # オリジナルのゆっくり高品質
        sample_fn = diffusion.p_sample_loop
    elif args.sampler == "ddim":           # 既存と同じ
...
def create_argparser():
    defaults = dict(
        ...
        target_model="",
        source_model="",
        # sampler="ddim",            # 追加: ["ddpm","ddim","dpm_solver"]
    )
    ...
    parser.add_argument(
        ...
        help="Number of sampling steps for dpm‑solver (NFE)。"  # デフォルト30はお好みで
    )
    parser.add_argument(
