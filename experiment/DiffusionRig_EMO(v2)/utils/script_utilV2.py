...
from diffusion.modelV2 import DiffusionRig
...
def model_and_diffusion_defaults():
    ...
    res = dict(
        ...
        # --- 変更箇所：shapeとidentityの次元数をデフォルト引数として追加 ---
        shape_dim=100,      # 例: DECAのshapeパラメータ次元数
        identity_dim=150,   # 例: DECAのidentity(shape+tex)パラメータ次元数
        # --- 変更ここまで ---
    )
...
def create_model_and_diffusion(
    ...
    latent_dim,
    # --- 変更箇所：関数の引数にshape_dimとidentity_dimを追加 ---
    shape_dim,
    identity_dim,
    # --- 変更ここまで ---
    in_channels,
